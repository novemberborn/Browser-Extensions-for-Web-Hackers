...
chrome.extension.sendRequest({ "settings": ["sameWindow", "expandURLs"] }, function(settings){
  ...
  settings.expandURLs && chrome.extension.sendRequest({ "hashes": parsed.hashes }, function(mapping){
    for(hash in mapping){
